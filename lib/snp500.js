...
function calculateMarkCap(company) {
  var last = company.hasOwnProperty('last') ? parseFloat(company.last.replace(/,/g,'')) : 1
  var sharesOutstanding = company.hasOwnProperty('sho') ? parseFloat(company.sho.replace(/,/g,'')) :  1
  return last * sharesOutstanding;
}
